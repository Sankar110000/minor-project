import { profileImage } from "@/components/config";
import {
  Entypo,
  Feather,
  Ionicons,
...
const TeacherProfile = () => {
  ...
  const profileFields = [
    ...
    {
      label: "Account ID",
      value: user?._id ? `${user._id.slice(0, 8)}...${user._id.slice(-4)}` : "—",
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: bgColor }}>
      ...
      >
        ...
        <View className="items-center mt-8 mb-6 px-5 rounded-full">
          <View className="relative mb-4 rounded-[50%] border border-orange-500 border-2">
            <View
        ...
        <View className="px-5 mt-2">
          ...
          >
            {profileFields.map((field, index) => (
              <View
                key={index}
                className={`flex-row items-center px-5 py-4 ${index < profileFields.length - 1
                  ? "border-b"
                  : ""
                  }`}
                style={{
